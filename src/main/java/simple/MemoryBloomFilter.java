...
/**
 * MemoryBloomFilter 实现
 *
 * @param <E> BloomFilter中数据的类型 如，String or Integer.
 */
public class MemoryBloomFilter<E> implements BloomFilter<E>,Serializable {
     ...
     * @param k 哈希函数个数
     */
    public MemoryBloomFilter(double c, int n, int k) {
     ...
     */
    public MemoryBloomFilter(int bitSetSize, int expectedNumberOElements) {
     ...
     */
    public MemoryBloomFilter(double falsePositiveProbability, int expectedNumberOfElements) {
     ...
     */
    public MemoryBloomFilter(int bitSetSize, int expectedNumberOfFilterElements, int actualNumberOfFilterElements, BitSet filterData) {
    ...
    public boolean equals(Object obj) {
        ...
        final MemoryBloomFilter<E> other = (MemoryBloomFilter<E>) obj;
